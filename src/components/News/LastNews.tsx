        ...
        {sortNewsData?.map((news) => {
          return (
            ...
            >
              ...
              >
                <h3
                  className="px-2 text-[20px] font-semibold line-clamp-1 text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:dark:text-blue-600 transition-colors"
                >
                  {news?.newsTitle}
                </h3>
                <p className="px-2  text-[17px] md:text-[19px] line-clamp-3 text-gray-500">
                  {news?.description
