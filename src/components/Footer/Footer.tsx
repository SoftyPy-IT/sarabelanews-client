  ...
  return (
    <footer className="bg-white text-black border-t">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* Links Section */}
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4 text-sm text-center md:text-left mb-8">
          <Link href="#">নাগরিক সংবাদ</Link>
          <Link href="#">কিশোর আলো</Link>
          <Link href="#">বিজ্ঞানচিন্তা</Link>
          <Link href="#">প্রথম আলো ট্রাস্ট</Link>
          <Link href="#">বন্ধুসভা</Link>
          <Link href="#">চিত্রকলা ১৯৭১</Link>
          <Link href="#">ই-পেপার</Link>
          <Link href="#">প্রথমা</Link>
          <Link href="#">মোবাইল ভাস</Link>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 border-t pt-6">
          ...
          <div className="flex gap-4 items-center">
            <span className="text-sm">অনুসরণ করুন</span>
      ...
      {/* Bottom Section */}
      <div className="bg-gray-100 text-xs text-center py-4 px-4">
        <div className="flex flex-wrap justify-center gap-3 mb-2">
          <Link href="#">প্রথম আলো</Link>|
          <Link href="#">বিজ্ঞাপন</Link>|
          <Link href="#">সার্কুলেশন</Link>|
          <Link href="#">শর্তাবলি ও নীতিমালা</Link>|
          <Link href="#">গোপনীয়তা নীতি</Link>|
          <Link href="#">যোগাযোগ</Link>|
          <Link href="#">নিউজলেটার</Link>
        </div>
        <p>
          সম্পাদক ও প্রকাশক: মতিউর রহমান <br />
          কপিরাইট © ১৯৯৮-২০২৫ প্রথম আলো
        </p>
      </div>
    </footer>
  );
